...
def update_cust_infos(pkl_path, out_dir):
    print(f'{pkl_path} will be modified.')
    if out_dir in pkl_path:
        print(f'Warning, you may overwriting '
              f'the original data {pkl_path}.')
...
def update_orchard_infos(pkl_path, out_dir):
    print(f'{pkl_path} will be modified.')
    if out_dir in pkl_path:
        print(f'Warning, you may overwriting '
              f'the original data {pkl_path}.')
...
def update_pkl_infos(dataset, out_dir, pkl_path):
    ...
    elif dataset.lower() == 'orchard':
        update_orchard_infos(pkl_path=pkl_path, out_dir=out_dir)
    elif dataset.lower() == 'custom':
        update_cust_infos(pkl_path=pkl_path, out_dir=out_dir)
    else:
